...
function wpRequestPosts(args) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const orderBy = {
            fieldName: (_c = (_b = args === null || args === void 0 ? void 0 : args.orderBy) === null || _b === void 0 ? void 0 : _b.fieldName) !== null && _c !== void 0 ? _c : 'DATE',
            direction: (_e = (_d = args === null || args === void 0 ? void 0 : args.orderBy) === null || _d === void 0 ? void 0 : _d.fieldName) !== null && _e !== void 0 ? _e : 'DESC',
        };
        const payload = `
    {
    posts
